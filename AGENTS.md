# AGENTS.md — aiMATA v2: Risk × Upward Probability Radar
...
Codex has MCP access to Supabase. Use it to inspect the exact schema before writing any queries.
...
```
aimata-v2/
├── AGENTS.md                      # ← YOU ARE HERE — master brief
...
Codex has Supabase MCP configured. Use it to:
